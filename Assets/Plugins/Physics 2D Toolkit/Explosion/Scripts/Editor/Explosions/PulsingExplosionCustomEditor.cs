...
[CustomEditor(typeof(PulsingExplosion))]
public class PulsingExplosionCustomEditor : ExplosionUniversalEditor {

	PulsingExplosion scriptRef;

	void OnEnable () {
		scriptRef = (PulsingExplosion)target;
