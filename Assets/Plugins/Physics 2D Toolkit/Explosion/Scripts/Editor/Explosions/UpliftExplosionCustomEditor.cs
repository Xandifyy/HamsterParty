...
[CustomEditor(typeof(UpliftExplosion))]
public class UpliftExplosionCustomEditor : ExplosionUniversalEditor {

	UpliftExplosion scriptRef;

	void OnEnable () {
		scriptRef = (UpliftExplosion)target;
